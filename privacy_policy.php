...
<div class="container interior-pages">
	<div class="row">
		<div class="col-xs-2">
			<a href="/"><img class="logo img-responsive" src="/assets/img/pp-icon.svg" alt="Partly Proper"></a>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-sm-8 col-md-8">
			...
			<p>In addition, we may use third party services such as Google Analytics that collect, monitor and analyze our log data.</p>
			...
			<h3>Contact Us</h3>
			<p>If you have any questions about this Privacy Policy, please <a href="mailto:email@email.com">contact us</a>.</p>
		</div>
	</div>
</div>
